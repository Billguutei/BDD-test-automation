Feature: баталгаа
 ...
 Scenario: Add Source to document Menu Positive Дансны үлдэгдлийн баталгаа
   Given login to ims
   And <document-maintenance> load page
   And check page loaded <Дансны үлдэгдлийн баталгаа >
   And etc document <HTML засах> <Дансны үлдэгдлийн баталгаа >
 ...
 Scenario: Delete Source to document Menu Positive Дансны үлдэгдлийн баталгаа 
   Given login to ims
   And <document-maintenance> load page
   And check page loaded <Дансны үлдэгдлийн баталгаа >
   And etc document <HTML засах> <Дансны үлдэгдлийн баталгаа >
 ...
 Scenario: Add Field to document Menu Positive Дансны үлдэгдлийн баталгаа
   Given login to ims
   And <document-maintenance> load page
   And check page loaded <Дансны үлдэгдлийн баталгаа >
   And etc document <HTML засах> <Дансны үлдэгдлийн баталгаа >
 ...
 Scenario: Edit Field to document Menu Positive Дансны үлдэгдлийн баталгаа
   Given login to ims
   And <document-maintenance> load page
   And check page loaded <Дансны үлдэгдлийн баталгаа >
   And etc document <HTML засах> <Дансны үлдэгдлийн баталгаа >
 ...
 Scenario: Delete Field to document Menu Positive Дансны үлдэгдлийн баталгаа
   Given login to ims
   And <document-maintenance> load page
   And check page loaded <Дансны үлдэгдлийн баталгаа >
   And etc document <HTML засах> <Дансны үлдэгдлийн баталгаа >
 ...
 Scenario: Change Order to document Menu Positive Дансны үлдэгдлийн баталгаа
   Given login to ims
   And <document-maintenance> load page
   And check page loaded <Дансны үлдэгдлийн баталгаа >
   And etc document <HTML засах> <Дансны үлдэгдлийн баталгаа >
 ...
 Scenario: Document Inputs to document Menu Positive Дансны үлдэгдлийн баталгаа
   Given login to ims
   And <document-maintenance> load page
   And check page loaded <Дансны үлдэгдлийн баталгаа >
   And etc document <HTML засах> <Дансны үлдэгдлийн баталгаа >
 ...
 Scenario: Edit HTML to document Menu Positive Дансны үлдэгдлийн баталгаа
   Given login to ims
   And <document-maintenance> load page
   And check page loaded <Дансны үлдэгдлийн баталгаа >
   And etc document <HTML засах> <Дансны үлдэгдлийн баталгаа >
 ...
 Scenario: Add Related Form to document Menu Positive Дансны үлдэгдлийн баталгаа
   Given login to ims
   And <document-maintenance> load page
   And check page loaded <Дансны үлдэгдлийн баталгаа >
   And etc document <HTML засах> <Дансны үлдэгдлийн баталгаа >
 ...
 Scenario: Change Configs to document Menu Positive Дансны үлдэгдлийн баталгаа
   Given login to ims
   And <document-maintenance> load page
   And check page loaded <Дансны үлдэгдлийн баталгаа >
   And etc document <HTML засах> <Дансны үлдэгдлийн баталгаа >
